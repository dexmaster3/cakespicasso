                ...
                <div class="col-lg-12">
                    <form action="/layout/layout/index" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="layout_parent" name="layout_parent" placeholder="Layout Parent" value="<?= $this->data->page['layout_parent']?>">
                        </div>
                        <div class="form-group hidden" style="display: none;">
                            <input type="text" class="form-control" id="id" name="id" value="<?= $this->data->page['id']?>">
                        </div>
                        <div class="form-group">
                            <label for="page_html">Layout Content</label>
                            <textarea rows="20" class="form-control" id="layout_content" name="layout_content" placeholder="Layout content"><?= $this->data->page['layout_content'] ?></textarea>
                        </div>
