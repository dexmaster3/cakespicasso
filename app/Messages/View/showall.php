...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a style="margin-bottom: 15px;" class="btn btn-success" href="/messages/message/create">New Message
                    +</a>
            </div>
        </div>
        <!-- /.row -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 toppad">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <a href="/messages/message/view?id=<?= $message['message_id'] ?>"><h3 style="color:white;"
                                                                                                  class="panel-title">
                                    From: <?= $message['username'] ?></h3></a>
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-3 col-lg-3" align="center">
                                    <? if (empty($message['avatar_crop']) && empty($message['avatar'])): ?>
                                        <img alt="User Pic" src="http://placehold.it/150x150"
                                             class="profile-image img-circle">
                                    <? elseif (empty($message['avatar_crop'])): ?>
                                        <img alt="User Pic" src="/assets/upload/<?= $message['avatar'] ?>"
                                             class="profile-image img-circle">
                                    <? else: ?>
                                        <img alt="User Pic" src="/assets/upload/<?= $message['avatar_crop'] ?>"
                                             class="profile-image img-circle">
                                    <? endif; ?>
                                </div>
                        ...
                        <div class="panel-footer">
                            <a data-original-title="Broadcast Message" data-toggle="tooltip"
                               class="btn btn-sm btn-primary" href="/messages/message/create"><i
